                  ...
                  <div class="location__map">
                        ...
                        <div class="contact">
                              ...
                              <div class="contact__btns">
                                    <Button class="contact__btns-btn" :blue="true" size="small" title="Написать в Вконтакте">
                                          <template #icon>
                                    ...
                                    <Button class="contact__btns-btn" :green="true" size="small" title="Написать в WhatsApp">
                                          <template #icon>
