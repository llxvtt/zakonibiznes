...
const buttonTitleFirst = ref("Написать в Вконтакте");
const buttonTitleSecond = ref("Написать в WhatsApp");

const updateButtonTitle = () => {
      if (window.innerWidth <= 576) {
            buttonTitleFirst.value = "Написать";
            buttonTitleSecond.value = "Написать";
      } else {
            buttonTitleFirst.value = "Написать в Вконтакте";
            buttonTitleSecond.value = "Написать в WhatsApp";
      }
};
