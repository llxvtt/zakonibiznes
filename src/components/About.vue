      ...
      <section class="about">
            <div class="container">
                  <div class="about__top section__top">
                        ...
                        <h2 class="about__top-title section__top-title">О компании <span>Правовой центр миграции</span></h2>
                  </div>
                  <div class="about__content">
                        ...
                        <div class="about__content-right">
                              ...
                              <Button class="about__content-btn" title="Бесплатная консультация" :primary="true" size="large" />
                        </div>
                  </div>
            </div>
      </section>
